...
public class ComputerEquipment extends Asset implements Depreciation{
	...
	public ComputerEquipment(String name, double value, String category, LocalDate registrationDate, String description, double usefulLife, String usefulLifeMedition) {
