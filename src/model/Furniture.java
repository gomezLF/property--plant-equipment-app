...
public class Furniture extends Asset implements Depreciation{
	...
	public Furniture(String name, double value, String category, LocalDate registrationDate, String description, double usefulLife, String usefulLifeMedition) {
